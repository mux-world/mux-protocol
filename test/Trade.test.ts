...
describe("Trade", () => {
  ...
  beforeEach(async () => {
    ...
    await pool.setAssetParams(0, toBytes32("AST0"), rate("0.1"), rate("0.05"), rate("0.01"), rate("0.01"), rate("0.01"), 10, 1)
    // id, tradable, openable, shortable, useStable, enabled, strict, liq, halfSpread, maxLong, maxShort
    await pool.setAssetFlags(0, true, true, true, false, true, true, true, rate("0"), toWei("10000000"), toWei("10000000"))
    ...
    // id, symbol, imr, mmr, fee, fee, minBps, minTime, spotWeight
    await pool.setAssetParams(1, toBytes32("AST1"), rate("0.1"), rate("0.05"), rate("0.01"), rate("0.01"), rate("0.01"), 10, 2)
    // id, tradable, openable, shortable, useStable, enabled, strict, liq, halfSpread, maxLong, maxShort
    ...
    // id, symbol, imr, mmr, fee, fee, minBps, minTime, spotWeight
    await pool.setAssetParams(2, toBytes32("AST2"), rate("0.1"), rate("0.05"), rate("0.01"), rate("0.01"), rate("0.01"), 10, 1)
    // id, tradable, openable, shortable, useStable, enabled, strict, liq, halfSpread, maxLong, maxShort
    await pool.setAssetFlags(2, true, true, true, false, true, false, true, rate("0"), toWei("10000000"), toWei("10000000"))
    ...
    // id, symbol, imr, mmr, fee, fee, minBps, minTime, spotWeight
    await pool.setAssetParams(3, toBytes32("AST3"), rate("0.1"), rate("0.05"), rate("0.01"), rate("0.01"), rate("0.01"), 10, 2)
    // id, tradable, openable, shortable, useStable, enabled, strict, liq, halfSpread, maxLong, maxShort
    await pool.setAssetFlags(3, true, true, true, true, true, false, true, rate("0"), toWei("10000000"), toWei("10000000"))
  ...
  it("add/remove liquidity is forbidden", async () => {
    ...
    await asset0.mint(pool.address, toWei("1000"))
    // id, tradable, openable, shortable, useStable, enabled, strict, liq, halfSpread, maxLong, maxShort
    await pool.setAssetFlags(0, true, true, true, false, true, true, false, rate("0"), toWei("10000000"), toWei("10000000"))
